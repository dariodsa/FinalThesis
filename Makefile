...
all: lex_yacc_part OBJECT_INDEX OBJECT_COLUMN OBJECT_TABLE OBJECT_DATABASE OBJECT_PROGRAM OBJECT_CONFIG OBJECT_PROXY OBJECT_RESULT
	$(CXX) $(CXXFLAGS)  -I data -o $(MAIN) $(SOURCE_CONFIG) src/main.cpp   $(OBJECT_INDEX) $(OBJECT_PROGRAM) $(OBJECT_DATABASE) $(OBJECT_TABLE) $(OBJECT_COLUMN)  $(OBJECT_PROXY) $(OBJECT_RESULT) $(LEX_YACC_FLAGS)  $(POSTGE_FLAGS)
